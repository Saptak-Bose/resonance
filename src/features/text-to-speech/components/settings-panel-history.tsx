...
export default function SettingsPanelHistory({}: Props) {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-2 p-8">
      ...
      <p className="max-w-48 text-center text-xs text-muted-foreground">
        On generation, your history will appear here. You can click on any item
        to view the details of that generation.
      </p>
    </div>
  );
}
