...
import { VOICE_CATEGORY_LABELS } from "@/lib/constants";
import type { TTSVoiceItem as VoiceItem } from "@/lib/types";
...
const parseLanguage = (locale: string) => {
...
export default function VoiceCard({ voice }: Props) {
  ...
  return (
    <div className="flex items-center gap-1 oveflow-hidden rounded-xl border pr-3 lg:pr-6">
          ...
          <DropdownMenuContent align="end">
            ...
            {voice.variant === "CUSTOM" && (
              ...
              >
                ...
                <span className="font-medium">Delete this voice...</span>
              </DropdownMenuItem>
            )}
          </DropdownMenuContent>
        </DropdownMenu>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  <span className="font-semibold">{voice.name}</span>? This
